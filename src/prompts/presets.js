...
export const STYLE_PRESETS = {
  ...
  "product-review": {
    label: "상품 리뷰",
    prompt: [
      "톤: 직접 구매해 일정 기간 써 본 사람의 상품 리뷰.",
      "- 첫 문단에 내돈내산/협찬 여부와 구매처·구매 가격을 명시 (자료에 있으면 그대로, 없으면 '구매처/가격은 본문 하단 참고'로)",
      "- 핵심 스펙을 표 또는 리스트로 요약한 섹션을 앞부분에 배치",
      "- 실사용 장점 섹션과 단점(아쉬운 점) 섹션을 반드시 분리 — 단점을 최소 2개 이상 솔직하게",
      "- 5점 만점 별점과 그 이유를 명시",
      "- '이런 분께 추천 / 이런 분께 비추천'을 나눠 정리하고, 재구매 의사로 마무리",
      "- 과장 광고 표현(최고, 인생템 남발) 금지 — 근거 있는 체감 위주",
    ].join("\n"),
  },
};
